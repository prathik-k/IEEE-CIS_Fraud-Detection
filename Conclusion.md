...
<p style="text-align: justify;">
  ...
  <br>
Overall, we achieved good performance with our tree-based models. Unsurprisingly, the SMOTE - Logistic Regression pipeline does not perform as well as the other tree-based methods we have implemented. We attribute this larger error to the following potential sources:
  <ul>
